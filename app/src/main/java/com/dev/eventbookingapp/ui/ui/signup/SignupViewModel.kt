...
class SignupViewModel @Inject constructor() : ViewModel() {
    ...
    fun tryCreateAccount(navController: NavController, appModel: AppModel) {
        ...
        Database.createAccount(email.trim(), password.trim())
            .addOnSuccessListener { data ->
                Database
                    .createUser(data.user!!.uid, email.trim())
                    .addOnSuccessListener {
                        ...
                        isLoading = false
                        alert = "Unable to create user data !"
                    }
            }.addOnFailureListener {
                isLoading = false
